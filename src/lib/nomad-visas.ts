...
export const NOMAD_VISAS: Record<string, NomadVisa> = {
  Montenegro: V("Digital Nomad Visa", 1400, 24, true, 84,
    "Exención del impuesto sobre la renta local para nómadas registrados",
    "Local income tax exemption for registered nomads"),
  Albania: V("Unique Permit for Digital Nomads", 817, 12, true, 82,
    "Sin impuesto local si tu renta es de fuente extranjera durante el primer año",
    "No local tax on foreign-source income during the first year"),
  Serbia: V("Permiso de residencia temporal para trabajo remoto", 1100, 12, true, 74,
    "Exención de impuesto local hasta 90 días; después residencia fiscal",
    "Local tax exemption up to 90 days; tax residency afterwards"),
  "El Salvador": V("Digital Nomad Visa", 1460, 24, true, 76,
    "Renta de fuente extranjera exenta; territorio con régimen bitcoin",
    "Foreign-source income exempt; bitcoin-friendly framework"),
  "Bosnia y Herzegovina": V("Visa de nómada digital", 1200, 12, true, 68,
    "Sin impuesto local sobre renta extranjera si no eres residente fiscal",
    "No local tax on foreign income if not a tax resident"),
  Andorra: V("Residencia pasiva / por cuenta propia", 3500, 12, true, 72,
    "IRPF máximo 10%; requiere depósito e inversión mínima",
    "Max 10% income tax; requires deposit and minimum investment"),
