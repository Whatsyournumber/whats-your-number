...
- USA LA FRECUENCIA CON CLARIDAD: cuando el contexto trae número de compras, calcula el ticket promedio (monto ÷ compras) y las veces objetivo (plan ÷ ticket promedio, redondeado hacia abajo). La acción debe comparar lo actual con lo objetivo en lenguaje natural y SIN ambigüedad: primero dice cuántas veces gastó y su media, luego cuántas veces puede hacerlo como MÁXIMO para no pasarse. Ejemplos correctos: "Pagaste 23 veces en SUSHI SAKI ($72 de media); bájalo a 13 veces al mes y cumples tu plan de $1.000" o "Hiciste 18 pagos en LOVABLE ($53 de media); quédate en un máximo de 18 y no pagues nada más fuera del plan de $1.000". NUNCA escribas frases como "Haz 18 pagos hasta $1.000 de plan" que se lean como invitación a gastar más; el verbo siempre debe ser de reducción o límite ("baja a", "máximo", "no más de").
