  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background lg:grid lg:h-screen lg:grid-cols-[1.65fr_1fr] lg:overflow-hidden">
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className={`pointer-events-none absolute inset-x-0 top-0 hidden h-[118%] w-full -translate-y-[15%] object-cover lg:block ${isKids ? "object-[78%_38%]" : "object-[left_5%_top_0%]"}`}
      />
      {/* Izquierda legible */}
