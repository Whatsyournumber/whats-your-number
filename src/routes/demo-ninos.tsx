  ...
  head: () => ({
    meta: [
      { title: "Demo gratis para padres — My First Number" },
      {
        name: "description",
        content:
          "3 preguntas y calculamos cuánto tendrá tu hijo a los 18 años invirtiendo en el S&P 500 al 10% anual con interés compuesto.",
      },
      { property: "og:title", content: "Demo gratis para padres — My First Number" },
      {
        property: "og:description",
        content: "Descubre el número de tu hijo a los 18 años. Tres preguntas, sin tarjeta.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:url", content: "https://whatsyour-number.com/demo-ninos" },
    ...
    links: [{ rel: "canonical", href: "https://whatsyour-number.com/demo-ninos" }],
  }),
