        ...
        >
          <div className="pointer-events-none absolute inset-x-0 top-0 h-[38vh] min-h-[260px] md:h-[50vh] lg:inset-y-0 lg:left-auto lg:right-0 lg:h-auto lg:min-h-0 lg:w-[68%]">
            <img
              ...
              width={1280}
              height={1024}
              className="h-full w-full object-cover object-[28%_8%] brightness-[1.75] contrast-[1.08] saturate-[1.06] md:object-[22%_14%] lg:object-[10%_38%] lg:[mask-image:linear-gradient(90deg,transparent_0%,transparent_34%,#000_70%,#000_100%)]"
            />
            {/* Gradual fade into the dark background so the photo never shows a hard edge */}
            <div className="absolute inset-y-0 left-0 hidden w-[30%] bg-[linear-gradient(90deg,var(--background)_0%,transparent_100%)] lg:block" />
            <div className="absolute inset-x-0 top-0 h-10 bg-[linear-gradient(180deg,var(--background)_0%,transparent_100%)] lg:h-16" />
            <div className="absolute inset-x-0 bottom-0 h-14 bg-[linear-gradient(0deg,var(--background)_0%,transparent_100%)] md:h-20 lg:h-24" />
          </div>
