        ...
        {stages.map((s) => (
          ...
          >
            ...
            <div className="relative flex min-h-[31rem] flex-col p-6 md:p-7">
              ...
              <ul className="mt-5 max-w-[54%] space-y-3.5">
                {s.features.map((f) => (
              ...
              <div className="mt-auto max-w-[54%] pt-10">
                <span
              ...
              <div className="pointer-events-none absolute bottom-6 right-4 w-[44%] max-w-[12.5rem]">{s.overlay}</div>
            </div>
