  ...
  const features = [
    {
      ...
      desc: t(
        "Registra tus gastos día a día por voz, foto o manualmente, compáralos con tu presupuesto y deja que la IA encuentre oportunidades para ahorrar más y acercarte a tu Número de libertad.",
        ...
        <section className="relative mt-24 min-h-[680px] overflow-hidden bg-background md:mt-32 md:min-h-[520px]">
          <div className="absolute inset-0 overflow-hidden md:left-[38%] md:[mask-image:linear-gradient(to_right,transparent_0%,rgba(0,0,0,0.35)_10%,rgba(0,0,0,0.7)_24%,#000_46%)]">
            <img
              ...
              width={1092}
              height={1250}
              className="h-full w-full object-contain object-top opacity-100 brightness-[1.3] contrast-[1.04] saturate-[1.06] md:scale-[1.02] md:object-cover md:object-[50%_50%]"
            />
          </div>
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-background from-30% via-background/60 via-52% to-transparent to-72% md:bg-gradient-to-r md:from-background md:from-20% md:via-background/60 md:via-48% md:to-transparent md:to-78%" />
          ...
          >
            ...
            <Button asChild className="mt-7 w-fit gap-2 rounded-full px-6">
              <Link to="/auth" search={{ mode: "signup" }}>
                {t("Comienza gratis ya", "Start free now")} <ArrowRight className="h-4 w-4" />
              </Link>
            </Button>
          </motion.div>
        </section>
