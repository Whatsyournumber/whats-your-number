            ...
            <div className="relative min-w-0 flex-1">
              ...
              <div className="mt-2.5 rounded-3xl rounded-bl-lg bg-card/95 px-3.5 py-2.5 shadow-sm">
                {buddyThinking && !buddyTip ? (
                  ...
                  <>
                    <p className="font-kid text-[15px] font-extrabold leading-tight text-foreground">
                      {buddyTip?.headline ?? `${t(`¡Genial, ${member.name}!`, `Great job, ${member.name}!`)} 🚀`}
                    </p>
                    <p className="mt-1 font-kid text-[13px] font-medium leading-snug text-muted-foreground">
                      {buddyTip?.insight ?? line}
                    </p>
                    {buddyTip?.tip ? (
                      <p className="mt-2 rounded-2xl bg-primary/10 px-2.5 py-1.5 font-kid text-[13px] font-semibold leading-snug text-foreground">
                        💡 {buddyTip.tip}
                      </p>
                    ) : null}
                  </>
