      ...
      <div className="grid grid-cols-[1rem_minmax(0,1.6fr)_minmax(0,2fr)_minmax(0,1.7fr)_minmax(3rem,1fr)] items-center gap-1.5 lg:gap-1">
        ...
        <div className="relative min-w-0">
          <Input
            ...
            className="numeric h-9 min-w-0 border-border/40 bg-elevated/50 pl-2 pr-6 text-xs"
          />
        ...
        >
          <div className="space-y-4">
            ...
            {simAssets.length === 0 ? (
              ...
              <div className="space-y-2">
                <div className="grid grid-cols-[1rem_minmax(0,1.6fr)_minmax(0,2fr)_minmax(0,1.7fr)_minmax(3rem,1fr)] items-center gap-1.5 px-1 pr-4 lg:gap-1">
