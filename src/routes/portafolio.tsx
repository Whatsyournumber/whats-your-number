    ...
    <div className="relative rounded-xl border border-border/50 bg-elevated/30 p-1 pr-4">
      ...
      <div className="grid grid-cols-[1rem_minmax(0,1.6fr)_minmax(0,2fr)_minmax(0,1.7fr)_minmax(4rem,1fr)] items-center gap-1.5 lg:gap-1">
            ...
            <div className="absolute left-0 top-10 z-30 w-[min(16rem,85vw)] overflow-hidden rounded-xl border border-border/60 bg-card/95 shadow-2xl backdrop-blur-xl">
              ...
              {!search.isFetching && hits.length === 0 && (
                <p className="px-3 py-2 text-xs text-muted-foreground">
                  {t("Sin resultados · escribe el rendimiento manual", "No results · enter the return manually")}
                </p>
              )}
            </div>
          )}
        ...
        <div className="relative min-w-0">
          ...
          <Input
            inputMode="numeric"
            value={asset.amount === 0 ? "" : group(Math.round(asset.amount))}
        ...
        <div className="relative min-w-0">
          ...
          <Input
            inputMode="numeric"
            value={asset.contribution === 0 ? "" : group(Math.round(asset.contribution))}
...
function PortafolioContent() {
  ...
  const newAssetKinds: Array<[HoldingKind, string, string]> = [
    ...
    ["property", t("REITs", "REITs"), t("Inversión inmobiliaria", "Real estate funds")],
        ...
        >
          ...
          {isCrypto ? (
            ...
            <>
              ...
              <div>
                <p className="text-[11px] text-muted-foreground">{h.type === "Cripto" ? t("Precio promedio", "Average price") : t("Strike price", "Strike price")}</p>
    ...
    <PageShell>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div data-tour-portfolio-target="value" className="relative h-full">
          <KpiCard
            ...
            valueTrailing={(
              <span
                className="ml-1 mt-1 inline-block h-2.5 w-2.5 shrink-0 self-center rounded-full bg-positive shadow-[0_0_0_4px_var(--color-positive-muted)] motion-safe:animate-pulse"
                aria-hidden="true"
              />
            )}
            accent
        ...
        >
          <div className="space-y-4">
            ...
            {simAssets.length === 0 ? (
              ...
              <div className="space-y-2">
                <div className="grid grid-cols-[1rem_minmax(0,1.6fr)_minmax(0,2fr)_minmax(0,1.7fr)_minmax(4rem,1fr)] items-center gap-1.5 px-1 pr-4 lg:gap-1">
            ...
            <div className="grid grid-cols-[1rem_minmax(0,1.6fr)_minmax(0,2fr)_minmax(0,1.7fr)_minmax(4rem,1fr)] items-center gap-1.5 border-t border-border/50 px-1 pr-4 pt-4 lg:gap-1">
              <span className="w-4 shrink-0" />
            ...
            <div className="space-y-2 border-t border-border/50 pt-4">
              <div className="flex items-center justify-between">
                <p className="text-[10px] font-medium text-muted-foreground">{t("Escenarios", "Scenarios")}</p>
                <Popover>
                  <PopoverTrigger asChild>
                    <button type="button" className="inline-flex h-5 w-5 items-center justify-center rounded-full text-muted-foreground hover:text-foreground" aria-label={t("Cómo se calcula", "How it is calculated")}>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-xl border border-positive/20 bg-positive/5 p-3">
                  ...
                  <p className="text-[10px] text-positive/80">+{optRate.toFixed(1)}% {t("anual", "annual")}</p>
                </div>
                <div className="rounded-xl border border-negative/20 bg-negative/5 p-3">
                  ...
                  <p className="text-[10px] text-negative/80">+{pesRate.toFixed(1)}% {t("anual", "annual")}</p>
                </div>
      ...
      >
        ...
        <div className="relative mt-2 overflow-hidden rounded-2xl border border-border/50 bg-elevated/50 px-4 py-3.5">
          <div className="grid grid-cols-2 items-center gap-3 lg:grid-cols-6">
            <div className="col-span-2 flex items-center gap-2 lg:col-span-2">
          ...
          >
            ...
            <p
              className={cn(
                ...
                isMobile && !aiExpanded && "max-h-[3.9em] overflow-hidden [mask-image:linear-gradient(to_bottom,black_55%,transparent)]",
              )}
            >
