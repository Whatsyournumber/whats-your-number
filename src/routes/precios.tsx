  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        t("Optimización fiscal y planificación patrimonial", "Tax optimization and estate planning"),
        t("Reportes trimestrales y anuales exportables", "Exportable quarterly and annual reports"),
        t("Perfiles familiares compartidos", "Shared family profiles"),
        t("Onboarding premium y advisor dedicado", "Premium onboarding and dedicated advisor"),
